 ...
 * @author sakshi
 */
public class BiochemistryFrame extends javax.swing.JInternalFrame {
    private BiochemistryJpaController biochemistrycontroller; 

    /**
     * Creates new form BiochemistryFrame
     */
    public BiochemistryFrame() {
        initComponents();
        
        biochemistrycontroller = Helper.getBiochemistryControllerInstance();
    }
    ...
    private void initComponents() {
        ...
        biochemistryQuery1 = java.beans.Beans.isDesignTime() ? null : LaboratoryPUEntityManager.createQuery("SELECT b FROM Biochemistry b");
        biochemistryList1 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : biochemistryQuery1.getResultList();
        ...
        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, biochemistryQuery, eLProperty, cmbTestName);
        bindingGroup.addBinding(jComboBoxBinding);
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, biochemistryQuery, org.jdesktop.beansbinding.ELProperty.create("${firstResult}"), cmbTestName, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
...
//        }
        ...
        biochemistry.setResults(txtResults.getText().trim());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
        in.laboratory.entity.Biochemistry biochemistry =
        (in.laboratory.entity.Biochemistry) cmbTestName.getSelectedItem();
        ...
        try{
            biochemistrycontroller.edit(biochemistry);
        } catch(Exception ex) {
    ...
    private java.util.List<in.laboratory.gui.Biochemistry> biochemistryList1;
    private javax.persistence.Query biochemistryQuery;
    private javax.persistence.Query biochemistryQuery1;
