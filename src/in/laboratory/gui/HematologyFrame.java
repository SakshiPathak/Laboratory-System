 ...
 * @author sakshi
 */
public class HematologyFrame extends javax.swing.JInternalFrame {
    private HematologyJpaController hematologycontroller;

    /**
     * Creates new form HematologyFrame
     */
    public HematologyFrame() {
        initComponents();
        
        //getRootPane().setDefaultButton(btnSave);
        hematologycontroller = Helper.getHematologyControllerInstance();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cmbTestName, org.jdesktop.beansbinding.ELProperty.create("${selectedItem.testName}"), txtTestName, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, hematologyQuery, eLProperty, cmbTestName);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, hematologyQuery, org.jdesktop.beansbinding.ELProperty.create("${firstResult}"), cmbTestName, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
...
//        }
        ...
        in.laboratory.entity.Hematology hematology =
                new in.laboratory.entity.Hematology();
        
        hematology.setTestName(txtTestName.getText().trim());
        hematology.setResults(txtResults.getText().trim());
        hematology.setNormalValues(txtNormalValues.getText().trim());
        
        hematologycontroller.create(hematology);
        updateUI();
        Helper.showSuccessMessage(this, "Hematology Test entries added successfully");
        txtTestName.setText("");
        txtResults.setText("");
        txtNormalValues.setText("");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
        in.laboratory.entity.Hematology hematology =
                (in.laboratory.entity.Hematology) cmbTestName.getSelectedItem();
        ...
        try{
             hematologycontroller.edit(hematology);
        } catch(Exception ex) {
                Logger.getLogger(PatientFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        updateUI();
        Helper.showSuccessMessage(this, "Hematology Test entries updated successfully");
        txtTestName.setText("");
        txtResults.setText("");
        txtNormalValues.setText("");
